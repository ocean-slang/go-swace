...
# Co-locating Argo floats with AVISO eddies 
...
# Open Argo data (choose 1 file)
#argo_df = pd.read_csv('../BGC_floats_Cornec_20250125.csv') # BGC Argo
argo_df = pd.read_csv('../Argo_floats_core_Cornec_20250504.csv') # Core Argo
...
# Save in-eddy Argo float data as CSV (choose 1)
#in_eddy_argo.to_csv('../BGC_floats_Cornec_20250125_in_eddy_LJK.csv', index=False)
in_eddy_argo.to_csv('../Argo_floats_core_Cornec_20250504_in_eddy_LJK.csv', index=False)
